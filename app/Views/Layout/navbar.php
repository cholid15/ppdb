    ...
    <header class="navbar navbar-expand-md d-print-none" style="background-color: green;" data-bs-theme="dark">
        <div class="container-xl">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href=".">
                    <img src="<?= base_url('assets/dist/img/1app_name.png') ?>" width="150" alt="Tabler"
                        class="navbar-image">
                </a>
            </h1>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                        ...
                        <div class="d-none d-xl-block ps-2">
                            <!-- !empty(auth()->user()->getEmailIdentity()->name) ? auth()->user()->getEmailIdentity()->name : -->
                            <div><?= 'Username' ?></div>
                            <div class="mt-1 small">User App</div>
                        </div>
                    </a>
