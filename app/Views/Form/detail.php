        ...
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('ppdb/update/' . $calonSiswa['id']) ?>" method="POST" id="dataForm"
                        ...
                        <div class="row mt-3" id="biodataRow">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select <?= (session('errors.id_sekolah')) ? 'is-invalid' : '' ?>"
                                    ...
                                    <?php foreach ($sekolahList as $s) : ?>
                                        <option value="<?= $s['id'] ?>"
                                            <?= (old('id_sekolah', $calonSiswa['id_sekolah']) == $s['id']) ? 'selected' : '' ?>>
                                            <?= $s['nama'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Masukkan NIS" value="<?= old('nis', $calonSiswa['nis']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.nis') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Masukkan NISN" value="<?= old('nisn', $calonSiswa['nisn']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.nisn') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Masukkan NIK (16 digit)" value="<?= old('nik', $calonSiswa['nik']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.nik') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="no_kk" placeholder="Masukkan No KK (16 digit)"
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('no_akta_lahir', $calonSiswa['no_akta_lahir']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Masukkan Nama Lengkap" value="<?= old('nama', $calonSiswa['nama']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.nama') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('tmpt_lahir', $calonSiswa['tmpt_lahir']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jk">
                                    ...
                                    <option value="L" <?= (old('jk', $calonSiswa['jk']) == 'L') ? 'selected' : '' ?>>
                                        Laki-Laki</option>
                                    <option value="P" <?= (old('jk', $calonSiswa['jk']) == 'P') ? 'selected' : '' ?>>
                                        Perempuan</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text"
                                        ...
                                        value="<?= old('tinggi_badan', $calonSiswa['tinggi_badan']) ?>">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text"
                                        ...
                                        value="<?= old('berat_badan', $calonSiswa['berat_badan']) ?>">
                                    <span class="input-group-text">
                                        KG
                                    </span>
                                </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="anak_ke" required>
                                    ...
                                    <option value="1"
                                        <?= (old('anak_ke') == '1' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '1')) ? 'selected' : '' ?>>
                                        1</option>
                                    <option value="2"
                                        <?= (old('anak_ke') == '2' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '2')) ? 'selected' : '' ?>>
                                        2</option>
                                    <option value="3"
                                        <?= (old('anak_ke') == '3' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '3')) ? 'selected' : '' ?>>
                                        3</option>
                                    <option value="4"
                                        <?= (old('anak_ke') == '4' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '4')) ? 'selected' : '' ?>>
                                        4</option>
                                    <option value="5"
                                        <?= (old('anak_ke') == '5' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '5')) ? 'selected' : '' ?>>
                                        5</option>
                                    <option value="6"
                                        <?= (old('anak_ke') == '6' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '6')) ? 'selected' : '' ?>>
                                        6</option>
                                    <option value="7"
                                        <?= (old('anak_ke') == '7' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '7')) ? 'selected' : '' ?>>
                                        7</option>
                                    <option value="8"
                                        <?= (old('anak_ke') == '8' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '8')) ? 'selected' : '' ?>>
                                        8</option>
                                    <option value="9"
                                        <?= (old('anak_ke') == '9' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '9')) ? 'selected' : '' ?>>
                                        9</option>
                                    <option value="10"
                                        <?= (old('anak_ke') == '10' || (!old('anak_ke') && $calonSiswa['anak_ke'] == '10')) ? 'selected' : '' ?>>
                                        10</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jml_saudara" required>
                                    ...
                                    <option value="1"
                                        <?= (old('jml_saudara') == '1' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '1')) ? 'selected' : '' ?>>
                                        1</option>
                                    <option value="2"
                                        <?= (old('jml_saudara') == '2' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '2')) ? 'selected' : '' ?>>
                                        2</option>
                                    <option value="3"
                                        <?= (old('jml_saudara') == '3' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '3')) ? 'selected' : '' ?>>
                                        3</option>
                                    <option value="4"
                                        <?= (old('jml_saudara') == '4' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '4')) ? 'selected' : '' ?>>
                                        4</option>
                                    <option value="5"
                                        <?= (old('jml_saudara') == '5' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '5')) ? 'selected' : '' ?>>
                                        5</option>
                                    <option value="6"
                                        <?= (old('jml_saudara') == '6' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '6')) ? 'selected' : '' ?>>
                                        6</option>
                                    <option value="7"
                                        <?= (old('jml_saudara') == '7' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '7')) ? 'selected' : '' ?>>
                                        7</option>
                                    <option value="8"
                                        <?= (old('jml_saudara') == '8' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '8')) ? 'selected' : '' ?>>
                                        8</option>
                                    <option value="9"
                                        <?= (old('jml_saudara') == '9' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '9')) ? 'selected' : '' ?>>
                                        9</option>
                                    <option value="10"
                                        <?= (old('jml_saudara') == '10' || (!old('jml_saudara') && $calonSiswa['jml_saudara'] == '10')) ? 'selected' : '' ?>>
                                        10</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="agama" required>
                                    ...
                                    <option value="Islam"
                                        <?= (old('agama') == 'Islam' || (!old('agama') && $calonSiswa['agama'] == 'Islam')) ? 'selected' : '' ?>>
                                        Islam</option>
                                    <option value="Kristen_protestan"
                                        <?= (old('agama') == 'Kristen_protestan' || (!old('agama') && $calonSiswa['agama'] == 'Kristen_protestan')) ? 'selected' : '' ?>>
                                        Kristen Protestan</option>
                                    <option value="Kristen_katolik"
                                        <?= (old('agama') == 'Kristen_katolik' || (!old('agama') && $calonSiswa['agama'] == 'Kristen_katolik')) ? 'selected' : '' ?>>
                                        Kristen Katolik</option>
                                    <option value="Hindu"
                                        <?= (old('agama') == 'Hindu' || (!old('agama') && $calonSiswa['agama'] == 'Hindu')) ? 'selected' : '' ?>>
                                        Hindu</option>
                                    <option value="Buddha"
                                        <?= (old('agama') == 'Buddha' || (!old('agama') && $calonSiswa['agama'] == 'Buddha')) ? 'selected' : '' ?>>
                                        Buddha</option>
                                    <option value="Konghucu"
                                        <?= (old('agama') == 'Konghucu' || (!old('agama') && $calonSiswa['agama'] == 'Konghucu')) ? 'selected' : '' ?>>
                                        Konghucu</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="pendidikan_terakhir" required>
                                    ...
                                    <option value="TK"
                                        <?= (old('pendidikan_terakhir') == 'TK' || (!old('pendidikan_terakhir') && $calonSiswa['pendidikan_terakhir'] == 'TK')) ? 'selected' : '' ?>>
                                        TK</option>
                                    <option value="SD"
                                        <?= (old('pendidikan_terakhir') == 'SD' || (!old('pendidikan_terakhir') && $calonSiswa['pendidikan_terakhir'] == 'SD')) ? 'selected' : '' ?>>
                                        SD</option>
                                    <option value="SMP"
                                        <?= (old('pendidikan_terakhir') == 'SMP' || (!old('pendidikan_terakhir') && $calonSiswa['pendidikan_terakhir'] == 'SMP')) ? 'selected' : '' ?>>
                                        SMP</option>
                                    <option value="SMA/K"
                                        <?= (old('pendidikan_terakhir') == 'SMA/K' || (!old('pendidikan_terakhir') && $calonSiswa['pendidikan_terakhir'] == 'SMA/K')) ? 'selected' : '' ?>>
                                        SMA/K</option>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3" id="alamatRow">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('provinsi', $alamat[0]['provinsi'] ?? '') ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('kabupaten', $alamat[0]['kabupaten']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('kecamatan', $alamat[0]['kecamatan']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('kelurahan', $alamat[0]['kelurahan']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('kode_pos', $alamat[0]['kode_pos']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control <?= (session('errors.alamat')) ? 'is-invalid' : '' ?>"
                                    name="alamat"
                                    placeholder="Masukkan Alamat Lengkap"><?= old('alamat') ? old('alamat') : $alamat[0]['alamat'] ?></textarea>
                                <div class="invalid-feedback">
                                    <?= session('errors.alamat') ?>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('ortu_no_ktp', $ortu[0]['ortu_no_ktp']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('ortu_no_kk', $ortu[0]['ortu_no_kk']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('nama_ortu', $ortu[0]['nama_ortu']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="tgl_lahir_ortu" name="tgl_lahir_ortu"
                                    placeholder="Pilih tanggal"
                                    value="<?= old('ortu_no_ktp', $ortu[0]['tgl_lahir_ortu']) ?>" required>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jk_ortu">
                                    <option value="" selected disabled>Pilih Jenis Kelamin</option>
                                    <option value="L"
                                        <?= (old('jk_ortu') == 'L' || (isset($ortu[0]['jk_ortu']) && $ortu[0]['jk_ortu'] == 'L')) ? 'selected' : '' ?>>
                                        Laki-Laki
                                    </option>
                                    <option value="P"
                                        <?= (old('jk_ortu') == 'P' || (isset($ortu[0]['jk_ortu']) && $ortu[0]['jk_ortu'] == 'P')) ? 'selected' : '' ?>>
                                        Perempuan
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jenjang_asal_ortu" required>
                                    <option value="" selected disabled>Pilih Jenjang</option>
                                    <option value="TK"
                                        <?= (old('jenjang_asal_ortu') == 'TK' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'TK')) ? 'selected' : '' ?>>
                                        TK</option>
                                    <option value="SD"
                                        <?= (old('jenjang_asal_ortu') == 'SD' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'SD')) ? 'selected' : '' ?>>
                                        SD</option>
                                    <option value="SMP"
                                        <?= (old('jenjang_asal_ortu') == 'SMP' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'SMP')) ? 'selected' : '' ?>>
                                        SMP</option>
                                    <option value="SMA/K"
                                        <?= (old('jenjang_asal_ortu') == 'SMA/K' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'SMA/K')) ? 'selected' : '' ?>>
                                        SMA/K</option>
                                    <option value="S1"
                                        <?= (old('jenjang_asal_ortu') == 'S1' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'S1')) ? 'selected' : '' ?>>
                                        S1</option>
                                    <option value="S2"
                                        <?= (old('jenjang_asal_ortu') == 'S2' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'S2')) ? 'selected' : '' ?>>
                                        S2</option>
                                    <option value="S3"
                                        <?= (old('jenjang_asal_ortu') == 'S3' || (isset($ortu[0]['jenjang_asal_ortu']) && $ortu[0]['jenjang_asal_ortu'] == 'S3')) ? 'selected' : '' ?>>
                                        S3</option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('no_hp_ortu', $ortu[0]['no_hp_ortu']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.no_hp') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('pekerjaan_ortu', $ortu[0]['pekerjaan_ortu']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="rentang_gaji_ortu" required>
                                    ...
                                    <option value="1 juta - 5 juta"
                                        <?= (old('rentang_gaji_ortu') == '1 juta - 5 juta' || (isset($ortu[0]['rentang_gaji_ortu']) && $ortu[0]['rentang_gaji_ortu'] == '1 juta - 5 juta')) ? 'selected' : '' ?>>
                                        1 juta - 5 juta</option>
                                    <option value="5 juta - 10 juta"
                                        <?= (old('rentang_gaji_ortu') == '5 juta - 10 juta' || (isset($ortu[0]['rentang_gaji_ortu']) && $ortu[0]['rentang_gaji_ortu'] == '5 juta - 10 juta')) ? 'selected' : '' ?>>
                                        5 juta - 10 juta</option>
                                    <option value="10 juta - 15 juta"
                                        <?= (old('rentang_gaji_ortu') == '10 juta - 15 juta' || (isset($ortu[0]['rentang_gaji_ortu']) && $ortu[0]['rentang_gaji_ortu'] == '10 juta - 15 juta')) ? 'selected' : '' ?>>
                                        10 juta - 15 juta</option>
                                    <option value="15 juta - 20 juta"
                                        <?= (old('rentang_gaji_ortu') == '15 juta - 20 juta' || (isset($ortu[0]['rentang_gaji_ortu']) && $ortu[0]['rentang_gaji_ortu'] == '15 juta - 20 juta')) ? 'selected' : '' ?>>
                                        15 juta - 20 juta</option>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('wali_no_ktp', $wali[0]['wali_no_ktp']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('wali_no_kk', $wali[0]['wali_no_kk']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('wali_nama', $wali[0]['wali_nama']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="tgl_lahir_wali" name="tgl_lahir_wali"
                                    placeholder="Pilih tanggal"
                                    value="<?= old('tgl_lahir_wali', $wali[0]['tgl_lahir_wali']) ?>">
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jk_wali">
                                    <option value="" selected disabled>Pilih Jenis Kelamin</option>
                                    <option value="L"
                                        <?= (old('jk_wali') == 'L' || (isset($wali[0]['jk_wali']) && $wali[0]['jk_wali'] == 'L')) ? 'selected' : '' ?>>
                                        Laki-Laki
                                    </option>
                                    <option value="P"
                                        <?= (old('jk_wali') == 'P' || (isset($wali[0]['jk_wali']) && $wali[0]['jk_wali'] == 'P')) ? 'selected' : '' ?>>
                                        Perempuan
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="jenjang_asal_wali">
                                    <option value="" selected disabled>Pilih Jenjang</option>
                                    <option value="TK"
                                        <?= (old('jenjang_asal_wali') == 'TK' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'TK')) ? 'selected' : '' ?>>
                                        TK
                                    </option>
                                    <option value="SD"
                                        <?= (old('jenjang_asal_wali') == 'SD' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'SD')) ? 'selected' : '' ?>>
                                        SD
                                    </option>
                                    <option value="SMP"
                                        <?= (old('jenjang_asal_wali') == 'SMP' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'SMP')) ? 'selected' : '' ?>>
                                        SMP
                                    </option>
                                    <option value="SMA/K"
                                        <?= (old('jenjang_asal_wali') == 'SMA/K' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'SMA/K')) ? 'selected' : '' ?>>
                                        SMA/K
                                    </option>
                                    <option value="S1"
                                        <?= (old('jenjang_asal_wali') == 'S1' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'S1')) ? 'selected' : '' ?>>
                                        S1
                                    </option>
                                    <option value="S2"
                                        <?= (old('jenjang_asal_wali') == 'S2' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'S2')) ? 'selected' : '' ?>>
                                        S2
                                    </option>
                                    <option value="S3"
                                        <?= (old('jenjang_asal_wali') == 'S3' || (isset($wali[0]['jenjang_asal_wali']) && $wali[0]['jenjang_asal_wali'] == 'S3')) ? 'selected' : '' ?>>
                                        S3
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    class="form-control <?= (session('errors.no_hp')) ? 'is-invalid' : '' ?>"
                                    name="no_hp_wali" placeholder="Masukkan Nomor HP"
                                    value="<?= old('no_hp_wali', $wali[0]['no_hp_wali']) ?>">
                                <div class="invalid-feedback">
                                    <?= session('errors.no_hp') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= old('pekerjaan_wali', $wali[0]['pekerjaan_wali']) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select class="form-select" name="rentang_gaji_wali">
                                    <option value="" selected disabled>Pilih Rentang Gaji</option>
                                    <option value="1 juta - 5 juta"
                                        <?= (old('rentang_gaji_wali') == '1 juta - 5 juta' || (isset($wali[0]['rentang_gaji_wali']) && $wali[0]['rentang_gaji_wali'] == '1 juta - 5 juta')) ? 'selected' : '' ?>>
                                        1 juta - 5 juta
                                    </option>
                                    <option value="5 juta - 10 juta"
                                        <?= (old('rentang_gaji_wali') == '5 juta - 10 juta' || (isset($wali[0]['rentang_gaji_wali']) && $wali[0]['rentang_gaji_wali'] == '5 juta - 10 juta')) ? 'selected' : '' ?>>
                                        5 juta - 10 juta
                                    </option>
                                    <option value="10 juta - 15 juta"
                                        <?= (old('rentang_gaji_wali') == '10 juta - 15 juta' || (isset($wali[0]['rentang_gaji_wali']) && $wali[0]['rentang_gaji_wali'] == '10 juta - 15 juta')) ? 'selected' : '' ?>>
                                        10 juta - 15 juta
                                    </option>
                                    <option value="15 juta - 20 juta"
                                        <?= (old('rentang_gaji_wali') == '15 juta - 20 juta' || (isset($wali[0]['rentang_gaji_wali']) && $wali[0]['rentang_gaji_wali'] == '15 juta - 20 juta')) ? 'selected' : '' ?>>
                                        15 juta - 20 juta
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="passfoto" value="Ya"
                                            <?= $berkasStatus['passfoto'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="passfoto" value="Ya"
                                            <= $berkasStatus['passfoto'] == 'Ya' ? 'checked' : '' ?>> Ya
                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="passfoto" value="Tidak"
                                            <= $berkasStatus['passfoto'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                    </label>
                                </div>
                            </div> -->
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="akta_kelahiran" value="Ya"
                                            <= $berkasStatus['akta_kelahiran'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="akta_kelahiran" value="Tidak"
                                            <= $berkasStatus['akta_kelahiran'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="akta_kelahiran" value="Ya"
                                            <?= $berkasStatus['akta_kelahiran'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kk" value="Ya"
                                            <= $berkasStatus['kk'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kk" value="Tidak"
                                            <= $berkasStatus['kk'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ijazah" value="Ya"
                                            <= $berkasStatus['ijazah'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ijazah" value="Tidak"
                                            <= $berkasStatus['ijazah'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                    </label>
                                </div>
                            </div> -->
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="ijazah" value="Ya"
                                            <?= $berkasStatus['ijazah'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kartu_nisn" value="Ya"
                                            ?= $berkasStatus['kartu_nisn'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kartu_nisn" value="Tidak"
                                            <= $berkasStatus['kartu_nisn'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                    </label>
                                </div>
                            </div> -->
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kartu_nisn" value="Ya"
                                            <?= $berkasStatus['kartu_nisn'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="raport" value="Ya"
                                            <= $berkasStatus['raport'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="raport" value="Tidak"
                                            <= $berkasStatus['raport'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="raport" value="Ya"
                                            <?= $berkasStatus['raport'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kip" value="Ya"
                                            <= $berkasStatus['kip'] == 'Ya' ? 'checked' : '' ?>> Ya
                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kip" value="Tidak"
                                            <= $berkasStatus['kip'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ktp_ortu" value="Ya"
                                            <= $berkasStatus['ktp_ortu'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ktp_ortu" value="Tidak"
                                            <= $berkasStatus['ktp_ortu'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="ktp_ortu" value="Ya"
                                            <?= $berkasStatus['ktp_ortu'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="akte_kematian" value="Ya"
                                            <= $berkasStatus['akte_kematian'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="akte_kematian" value="Tidak"
                                            <= $berkasStatus['akte_kematian'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="akte_kematian" value="Ya"
                                            <?= $berkasStatus['akte_kematian'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bukti_bayar" value="Ya"
                                            <= $berkasStatus['bukti_bayar'] == 'Ya' ? 'checked' : '' ?>> Ya

                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bukti_bayar" value="Tidak"
                                            <= $berkasStatus['bukti_bayar'] == 'Tidak' ? 'checked' : '' ?>> Tidak
                                ...
                                <div>
                                    <label class="form-check">
                                        <input class="form-check-input" type="checkbox" name="bukti_bayar" value="Ya"
                                            <?= $berkasStatus['bukti_bayar'] == 'Ya' ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
